...
router.get('/DECIPHER/genomeloc/:hg19Chr/:hg19Start/:hg19Stop', decipherController.findByGenomicLocation);

router.get('/DECIPHERDisease/variant/:variant', decipherDiseaseController.findByVariant);
router.get('/DECIPHERDisease/genomeloc/:hg19Chr/:hg19Start/:hg19Stop', decipherDiseaseController.findByGenomicLocation);
